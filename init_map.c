...
/*   Updated: 2024/02/24 15:17:47 by ebaillot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_next_part(t_resources *resources, int num_of_lines, int fd)
{
	...
	isCheck = check_path_exists(resources->game_map->map_data,
			resources->game_map->map_length, resources->game_map->map_height,
			resources->game_map->player_position_x,
